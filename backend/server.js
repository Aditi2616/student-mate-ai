...
// ✅ CORS FIX: Sabhi origins allow kar diye (Netlify + Localhost dono chalenge)
app.use(cors({
    origin: '*', 
...
// Welcome Route (Check karne ke liye ki API zinda hai)
app.get('/', (req, res) => {
    res.send('🚀 StudentMate AI API is running and live!');
});
